                ...
                <div class="container flex">
                    <div class="input grid">
                        <div class="box">
                            ...
                            <input type="date" name="dated" id="dated" placeholder="Check-in-Date">
                        </div>
                        <div class="box">
                            <label>Check-out</label>
                            <input type="date" name="datef" id="datef" placeholder="Check-out-Date">
                        </div>
                        <div class="box">
                            <label>Adults</label>
        ...
        <div class="row">
            ...
            <?php if(isset($roomres)){ ?>
                ...
                <?php if($res['typeR'] == 'suite'){ ?>
                    <form action="http://pestana.com/room/getRoomR/<?php echo $res['idR'] ?>" method="POST">
                        <div class="col-md-3">
                ...
                <?php }else if($res['typeR'] == 'single' || $res['typeR'] == 'double'){ ?>
                    <form action="<?php echo 'bookRoom' ?>" method="POST">
                        <div class="col-md-3">
                            <div class="card" style="width: 18rem;">
