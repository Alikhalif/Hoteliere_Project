            ...
            <div class=" d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <!-- <?php include "./views/includes/alerts.php" ?> -->
                  ...
                  <div class="form-outline mb-2">
                    <input type="number" name="number" class="form-control" id="form2Example27" aria-describedby="emailHelp" placeholder="number">
                  </div>

                  <div class="form-outline mb-2">
                    <input type="number" name="price" class="form-control" id="form2Example27" placeholder="Price">
                  </div>

                  <div class="form-outlin mb-2">
                    <input type="number" name="capacite" class="form-control" placeholder="Capacity" id="">
                  </div>
                  ...
                  <div class="pt-1 mb-2">
                    <button type="submit" name="btnAdd" class="btn btn-dark  btn-block addd"  style="background-color: rgb(133, 88, 88)">ADD</button>
                  </div>
